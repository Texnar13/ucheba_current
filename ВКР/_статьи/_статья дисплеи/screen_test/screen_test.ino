...
void loop(void) {
  ...
  // u8g2.drawBox(x,         y+1,         1,     value-2);
  // u8g2.drawBox(x,         y,         value, 1);
  // u8g2.drawBox(x+value-1, y+1,         1,     value-2);
  // u8g2.drawBox(x,         y+value-1, value, 1);
  ...
  u8g2.clearBuffer();
  u8g2.drawStr(10,10,"Hello");	// write something to the internal memory
  u8g2.drawStr(10,40,"World!");	// write something to the internal memory
  u8g2.sendBuffer();
  delay(6000);  
